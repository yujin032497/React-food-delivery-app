            ...
            <Container>
                <Row>
                    <Col lg="12" className="text-center">
                        ...
                        <h2 className="feature__title">we will
                            <span> take care</span>
                        </h2>
                        <p className="mb-1 mt-4 feature__text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolor, officiis?</p>
                        <p className="feature__text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aperiam, eius.{" "}</p>
                    </Col>
                    ...
                    <Row>
                        ...
                        <Col lg="6" md="6">
                            <div className="why__tasty-treat">
                                ...
                                <p className="tasty__treat-desc">Lorem ipsum dolor sit amet consectetur adipisicing 
                                elit. Dolorum, minus. Tempora reprehenderit a corporis
                                velit, laboriosam vitae ullam, repellat illo sequi odio
                        ...
                        <Col lg="6" md="6">
                            <div className="testimonial">
                                ...
                                <p className="testimonial__desc">
                                    ...
                                    elit.
                                    Distinctio quasi qui minus quos sit perspiciatis
                                    inventore
